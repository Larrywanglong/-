...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [[HTTPManager defaultHttpManager] getWeatherWithCityName:@"beijing"];
    return YES;
}
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "Larry.____" in the application's documents directory.
